...
{/* Whatsapp */}
                <div className="contact__card">
                  ...
                  <a href="https://api.whatsapp.com/send?phone=6386064964&text=Hello" target='_blank' className="contact__button">
                  Write Me{""}
                    <i className="bx bx-right-arrow-alt contact__button-icon"></i>
                  </a>
                </div>
            ...
            <div className="contact__content">
              ...
              {/* name */}
                <div className="contact__form_div">
                  <label htmlFor="" className='contact__from-tag'>Name</label>
                  <input type="text" name='name' className='contact__form-input'
                  placeholder='Enter Your Name' />
                </div>
                {/* email */}
                <div className="contact__form_div">
                  <label htmlFor="" className='contact__from-tag'>Email</label>
